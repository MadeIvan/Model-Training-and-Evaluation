...
model_path='D:\SEMESTER 5\Machine Learning\Tugas_A_12063'
...
ChestPainType= st.selectbox("Resting Blood Preassure",["ASY","ATA","NAP","TA"])
...
MaxHR=st.number_input("Max Heart Rate", 60,302)
ExcerciseAngina=st.radio("Excercise Angina",["N","Y"])
Old_peak= st.slider("Old Peak",-1.0,7.0,step=0.1)
